...
import {TRENDING_API, IMAGE_API} from '../utils/constant'
...
const Hero = () => {
    ...
    return (
        <div>
            <section className="pt-36 md:pb-16">
                <div className="container mx-auto">
                    <h1 className="text-lg md:text-3xl ml-4 text-white font-bold">Trending on This Week</h1>
